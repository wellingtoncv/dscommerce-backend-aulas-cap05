...
public class ProductControllerIT {
	...
	void setUp() throws Exception {
		...
		product = new Product(null, "Console PlayStation 5", "Lorem ipsum, door set amet consectetur adipisicing elit.",3999.90, "https://raw.githubusercontent.com/devsuperior/dscatalog-resources/master/backend/img/1-big.jpg");
	...
	public void insertShouldReturnProductDTOCreatedWhenAdminLogged() throws Exception {
		...
		result.andExpect(jsonPath("$.description").value("Lorem ipsum, door set amet consectetur adipisicing elit."));
